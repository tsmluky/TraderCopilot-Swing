...
function LoginContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 3. Redirect is handled in context or here if specific logic needed
      // (Context handles basic redirect to /dashboard, but we can override if searchParams.next exists)
      ...
      if (err?.message?.includes('401') || err?.name === 'AuthError') {
