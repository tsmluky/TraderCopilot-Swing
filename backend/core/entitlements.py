...
QUOTAS = {
    ...
    TIER_TRADER: {"ai_analysis": 5, "advisor_chat": 0}, # SwingLite: No Advisor, limited LITE runs
    TIER_PRO: {"ai_analysis": 20, "advisor_chat": 60}, # Fair Use: 20 analyses, 60 chats
...
def get_user_entitlements(db: Session, user: User):
    ...
    from core.timeframe_policy import allowed_timeframes_for
